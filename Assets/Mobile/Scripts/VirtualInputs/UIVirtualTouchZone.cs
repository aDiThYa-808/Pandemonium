...
public class UIVirtualTouchZone : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [Header("Settings")]
    public bool clampToMagnitude = true;
    public float magnitudeMultiplier = 1f;
    public bool invertXOutputValue;
    public bool invertYOutputValue;
    public float dragThreshold = 5f; // Minimum distance to start dragging
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        // Output zero to ensure no unintended movement starts
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if (!isDragging && positionDelta.magnitude > dragThreshold)
        {
            isDragging = true;
        }
    ...
    {
        // Only output movement when actively dragging
        if (isDragging)
        {
